...
function showEmptyState() {
  ...
  messagesDiv.innerHTML = `
    <div class="empty-state">
      <button type="button" class="empty-state-help" onclick="playNormalClick(); showHelpModal()" title="See a sample of what your AI Chief of Staff can do">
        ...
        <span>Click here to see a sample of<br>what I can do for your life and business</span>
